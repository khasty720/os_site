...
<html lang="en">
  ...
  <body>
          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                <li><a href="#" onclick="scroll_to_services()">Services</a></li>
                <li><a href="#" onclick="scroll_to_about()">About Us</a></li>
                <li><a href="#" onclick="scroll_to_projects()">Projects</a></li>
                <li><a href="#" onclick="scroll_to_portfolio()">Portfolio</a></li>
                <li><a href="#" onclick="scroll_to_contact()">Contact Us</a></li>
              </ul>
              <!--
    ...
    <div class="main">
    	...
    	<section id="section_home" class="home">
        	<div class="quote">
            	"If I were asked to say what is at once the most important production of Art and the thing most longed for, I should answer
                <span class="script">A Beautiful House</span>
                <span class="author">William Morris</span>
            </div>
        </section>
